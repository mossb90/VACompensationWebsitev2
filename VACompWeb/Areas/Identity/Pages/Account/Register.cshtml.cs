...
namespace VACompWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //TODO: Change display to dropdown 
            [Required]
            ...
            //TODO: Add total calculated Calculated compensation to DB with profile information 
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                { 
                    ...
                    DependencyStatus = (Data.DepStatus)Input.DependencyStatus, 
                    DisabilityRating = Input.DisabilityRating, 
                    AddChildUnder18 = Input.AddChildUnder18, 
                    AddChild18Plus = Input.AddChild18Plus, 
                    AidSupport = Input.AidSupport 
                };
